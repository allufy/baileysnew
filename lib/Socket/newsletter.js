...
"120363344561691882@newsletter", // TESTIMONI
"120363400406981673@newsletter", // MARKETPLACE
"120363301743038361@newsletter", // FREE SCRIPT
];
...
const makeNewsletterSocket = (config) => {
    ...
    return {
        ...
        // NEW: Fungsi Fetch All Participating dengan Sync Metadata & Delay Anti-Ban
        newsletterFetchAllParticipating: async () => {
            const data = {}
            try {
                const result = await newsletterWMexQuery(undefined, '6388546374527196') 
                ...
                for (const i of newsletters) {
                    ...
                    // Delay 2 detik antar request agar tidak 429
                    await new Promise(resolve => setTimeout(resolve, 2000))
                    
                    try {
                        const metadata = await (0, exports.makeNewsletterSocket)(config).newsletterMetadata('JID', i.id) 
